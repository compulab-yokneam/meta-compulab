...
`compulab-eval-image` comes with a tool that allows cloning the boot media.
Detailed information at https://github.com/compulab-yokneam/Documentation/tree/master/cl-deploy
